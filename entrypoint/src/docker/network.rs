...
const SUBNETS: [Ipv4Net; 11] = [
    Ipv4Net::new_assert(Ipv4Addr::new(172, 21, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 22, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 23, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 24, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 25, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 26, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 27, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 28, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 29, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 30, 0, 0), 16),
    Ipv4Net::new_assert(Ipv4Addr::new(172, 31, 0, 0), 16),
];
...
async fn flecs_network_setup(docker_client: &Docker) -> Result<Ipv4Addr, NetworkSetupError> {
        ...
        .await
    {
        ...
        Err(bollard::errors::Error::DockerResponseServerError {
            ...
            let adapters = net_spider::network_adapter::NetworkAdapterReaderImpl
            ...
            let subnet = SUBNETS
                .iter()
                .find(|subnet| {
                    existing_ip_addresses.iter().all(
                        |existing_ip_address| match existing_ip_address {
            ...
            let gateway = subnet.addr() | Ipv4Addr::new(0, 0, 0, 1);
            docker_client
